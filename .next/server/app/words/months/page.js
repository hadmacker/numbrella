...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const originalPathname = "/words/months/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/words/months/page","pathname":"/words/months","bundlePath":"app/words/months/page","filename":"","appPaths":[]}}
...
function getRandomMonth(excludeMonth) {
    // Create a new array containing months other than the excluded month
    const availableMonths = excludeMonth ? months.filter((month)=>month !== excludeMonth) : months;
