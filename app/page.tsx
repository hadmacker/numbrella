    ...
    <main className="overflow-y-auto">
        ...
        <div key="n1">
          ...
          <ul key="n1.1" className='block'>
            ...
            <li key="n1.1.2.4.alltwos" className='mx-3 my-3 md:mx-:3 md:my-6'><a href="numbers/allpowersoftwo"><span className="mx-2 p-4 text-2xl md:text-3xl font-black">List of Powers of Two</span></a></li>
            <li key="n1.1.2.4.threes" className='mx-3 my-3 md:mx-:3 md:my-6'><a href="numbers/powersofthree"><span className="mx-2 p-4 text-2xl md:text-3xl font-black">Powers of Three</span></a></li>
            <li key="n1.1.2.4.allthrees" className='mx-3 my-3 md:mx-:3 md:my-6'><a href="numbers/allpowersofthree"><span className="mx-2 p-4 text-2xl md:text-3xl font-black">List of Powers of Three</span></a></li>
