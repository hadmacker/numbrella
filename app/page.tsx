      ...
      <main>
        ...
        <div key="a1">
          ...
          <ul key="a1.1" className='block'>
            ...
            <li key="a1.1.2.9" className='mx-3 my-3 md:mx-:3 md:my-6'><a href="activities/stepsquad"><span className="mx-2 p-4 text-2xl md:text-3xl font-black">Step Squad</span></a></li>
          </ul>
        </div>
        </div>
