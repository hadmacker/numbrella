...
export default function Page() {
  ...
  for (let i = 0; i <= n; i++) {
    const answer = Math.pow(2, i);
    divElements.push(
      <div key={i}>
        {Formula(i, 2, answer, false)}
      </div>
    );
  }
  ...
  return (
    <>
      <span className="mx-3 md:mx-2 md:p-1 text-2xl md:text-3xl font-black text-gray-500">List of Powers of Two</span>
